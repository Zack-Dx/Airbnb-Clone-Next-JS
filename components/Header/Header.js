  ...
  return (
    <header className="sticky items-center top-0 z-50 grid grid-cols-3 space-x-2 bg-white shadow-md p-5 md:px-10">
      ...
      <div className="relative flex items-center h-10 cursor-pointer">
        <Image
          src={
            "https://res.cloudinary.com/dvj8ajii0/image/upload/v1684054630/airbnb/580b57fcd9996e24bc43c513_bo25v6.png"
          }
          fill
      ...
      {/* Mid Search */}
      <div className="flex items-center justify-center md:border-2 p-2 rounded-full  md:shadow-md">
      ...
      <div className="flex items-center justify-end space-x-2 text-gray-500">
        ...
        <div className="flex space-x-2 border-2 p-1 md:p-2 rounded-full ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
